 ...
 */
kibanaApp.controller('everyDesktopController', ['$scope', '$http', 'Upload','$rootScope','$timeout','$interval','$state','$location','$window',
...
// Button Disabling Functions
        ...
        $scope.uploadDesktopFile1 = function () {
...
// for step 1 end
        $scope.openDesktopRide = function () {
            $http({
                method: 'post',
                url: '/executeDesktop'
            });
        ...
        $scope.openWinium = function () {
            $http({
                method: 'post',
                url: '/openWinium'
            });
            $scope.ngModel1 = "Winium will be opening shortly.";

            setTimeout(function () {
                $scope.$apply(
                    $scope.ngModel1 = "Winium has opened. Please remember to close it."
                )
            },60000);
            $('#mobileExecuteTestCaseModal2').modal('hide');
        };
        ...
        $scope.openDesktopJenkins = function () {
            var desktop = "Desktop";
